...
public class HelloPushMessageGenerator {
    ...
    static Optional<HelloPushMessage> generateSleepScoreMessage(final PushNotification.UserPushNotification userPushNotification) {
        ...
        final HelloPushMessage msg = new HelloPushMessage(String.format("Your Sleep Score last night was %d.", userPushNotification.getNewSleepScore().getScore()), "sleep_score", nightOf );
