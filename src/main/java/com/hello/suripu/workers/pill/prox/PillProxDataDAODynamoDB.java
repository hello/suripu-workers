...
public class PillProxDataDAODynamoDB extends TimeSeriesDAODynamoDB<PillProxData> {
    ...
    protected Map<String, AttributeValue> toAttributeMap(PillProxData pillProxData) {
        ...
        item.put(PillDataAttribute.PROX4.name, new AttributeValue().withN(String.valueOf(pillProxData.proxValue4)));
    ...
    private PillProxData fromDynamoDBItem(final Map<String, AttributeValue> item) {
        return PillProxData.create(88L, "test", 99, 999, DateTime.now());
    }
    ...
    private Response getItemsBetweenTS(final long accountId,
        ...
        return new Response(results, response.status, response.exception);
    }

    private Response getItemsBetweenLocalTS(final long accountId,
