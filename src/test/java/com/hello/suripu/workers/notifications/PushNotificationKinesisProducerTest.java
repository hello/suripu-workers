 ...
 */
public class PushNotificationKinesisProducerTest {

    private PushNotificationKinesisProducer pushNotificationKinesisProducer;
    ...
    public void setUp() throws Exception {
        ...
        pushNotificationKinesisProducer = new PushNotificationKinesisProducer(STREAM_NAME, amazonKinesis);
    }
    ...
    public void testPutNotificationsEnsuresSenseIdPresent() throws Exception {
        final List<PushNotification.UserPushNotification> pushNotifications = ImmutableList.of(
                ...
                PushNotification.UserPushNotification.newBuilder().setAccountId(1L).build() // No sense ID
        );
    ...
    public void testPutNotificationsHappyPath() throws Exception {
        ...
        final List<PushNotification.UserPushNotification> failedNotifications = pushNotificationKinesisProducer.putNotifications(pushNotifications);
